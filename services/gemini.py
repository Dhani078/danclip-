...
async def analyze_video(video_path: str, custom_prompt: str = "", clip_count: int = 3, custom_api_key: str = "") -> GeminiAnalysisSchema:
    ...
    try:
        ...
        prompt = (
            ...
            f"- `hook_title`: Buat 3-5 kata HOOK UTAMA yang SANGAT PROVOKATIF & MEMANCING PENASARAN. Sesuaikan secara otomatis dengan konteks video yang sedang dibahas!\n"
            f"- `tiktok_caption`: Buat caption khas TikToker pro yang interaktif:\n"
            f"   1. Baris pertama: Hook emosional yang menyapa audiens (contoh: 'Kalian yang lagi ngalamin [topik] wajib dengerin ini... 🔥').\n"
            f"   2. Isi: Poin penting/rangkuman pesan utama narasumber dalam bahasa santai & menyentuh.\n"
            f"   3. Pertanyaan pemicu komentar: Ajukan pertanyaan relevan dengan topik video untuk memancing audiens berdiskusi di kolom komentar.\n"
            f"   4. Hashtag: Sertakan hashtag viral yang spesifik dan relevan dengan topik video tersebut + #fyp #viral.\n"
